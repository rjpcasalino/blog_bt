...
>I am not good at naming things. Too literal. Names like "Cylontian" or "Zorinthitech" may be trendy, but they aren't my style. "Lwarp" is what came to mind because it is warping the original function of LaTeX to do new things, and it sounds better than "Ldistort" or "LMangleinBizarreWays" or whatever, and the usual HTML-related names have already been taken. - https://github.com/bdtc/lwarp/discussions/10
